...
<form method="post">
	...
	<input name="senhaconf" type="password" /> <br /> 
	</br>
	...
	<input name="emailconf" type="email"  /> <br /> 
	</br>
	<label for="data"><b>Data de Nascimento</b></label><br /> 
	<input name="data" type="date"  /> <br /> 
	</br>
	<input name="term" type="checkbox" value="checado" /> Eu li e concordo com os <a href="termos-de-uso" target="_blank"  class="classe2link2">termos de uso.</a><br /> 
	</br>
